...
const testimonials = [
  {
    ...
    image: "/assets/ksdahv_1762783464000.jpeg",
    feedback:
  ...
  },
  {
    ...
    image: "/assets/images (1)_1762782661761.jpeg",
    feedback:
  ...
  },
  {
    ...
    image: "/assets/download (1)_1762783668250.jpeg",
    feedback:
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 md:p-12">
            <div className="flex flex-col md:flex-row gap-8">
              <div className="flex-shrink-0">
                <div className="w-32 h-32 md:w-40 md:h-40 rounded-lg overflow-hidden bg-muted border-2 border-primary/10 relative">
                  <Image
