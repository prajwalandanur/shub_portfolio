      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex items-center justify-center">
            <div 
              className="w-full max-w-md aspect-square rounded-lg overflow-hidden border-4 border-white shadow-2xl relative"
              data-testid="profile-photo"
            >
              <Image 
                src="/assets/WhatsApp Image 2025-01-12 at 12.41.08 PM_1762782243694.jpeg"
                alt="Shubhanga C S" 
                fill
